...
global.owner = process.env.OWNER_NUMBER  || '94771232992' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mFtmQLjJ#i6-8JlTau-d0E3MQFZsb49dD9y1VbuSGeg799NcY7hE' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94771232992" : process.env.MODERATORS ,    
